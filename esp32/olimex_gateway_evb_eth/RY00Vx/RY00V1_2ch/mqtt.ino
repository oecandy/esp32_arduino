...
void mqttPublishHealthCheck(){
  snprintf(message, 200, "{\"ip\":\"%s\",\"rssi\":\"%s\",\"relayChannel\":%ld,\"serialNo\":\"%s\",\"heap\":%ld}", WiFi.localIP().toString().c_str(), String(WiFi.RSSI()).c_str(), RELAY_TYPE, SERIAL_NO, ESP.getFreeHeap());
