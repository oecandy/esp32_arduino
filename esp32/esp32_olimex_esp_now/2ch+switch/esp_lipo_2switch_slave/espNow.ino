...
void sendPayload (){
    ...
    myData.switch_no = changeSwitch;
    myData.relay_state[0] = relayStatus[0] == 1 ? 0:1;
    myData.relay_state[1] = relayStatus[1] == 1 ? 0:1;
    myData.flow_count[0] = 0;
    myData.flow_count[1] = 0;
