...
#define   MESH_PREFIX     "SKEP-DSR"
//#define   MESH_ID         3174052525
#define   ROOT_ID         3174050085
...
Task sensorTask(6000, TASK_FOREVER, &sensorLoop);  // Send message to the logServer every 6 seconds 
...
void setup() {
  ...
  mesh_setup();
  modbusSetup();
  userScheduler.addTask(sensorTask);   // Add the task to the your scheduler
  sensorTask.enable();
}
