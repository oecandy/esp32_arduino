...
#define FLOW_METER_1_PIN  36 // flow data pin, GPIO 15
#define FLOW_METER_2_PIN  39 // flow data pin, GPIO 15
#define FLOW_METER_3_PIN  35 // flow data pin, GPIO 15
#define FLOW_METER_4_PIN  5// flow data pin, GPIO 15
