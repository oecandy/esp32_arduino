...
#define register_size 255 // 현재 버퍼 사이즈 락이 걸려있어서 255 가 맥스로 설정되어 있음 이 부분을 해결할 방법이 필요함.
...
void loop_modbus(){
  slave.poll(modbus_array,register_size);       //Used to receive or write value from Master
