...
//
//	2020-08-19
//	- LoRa Server update하면서 Topic이 변경됨
//											업데이트 전 => 업데이트 후
// application/{application_id}/device/{device_eui}/rx => application/{application_id}/device/{device_eui}/event/up
// application/{application_id}/device/{device_eui}/tx => application/{application_id}/device/{device_eui}/command/down
// application/{application_id}/device/{device_eui}/join => application/{application_id}/device/{device_eui}/event/join	
//
//
//	2020-07-06
//	- 농약, 원수 밸브 따로 분리해서 제어하도록 수정하면 농약 밸브 3개 주석처리
//
//
//	2020-04-08
//	- 밸브 보드 mqtt로 검증하기 위한 플래그 추가
//
//
//  2020-04-07
//	- 동작  구현 완료
//	- 스위치 입력 받으면 통신 전송하고, 30초동안 변화 없으면 재전송
//
//
//  2020-04-06
//  - Control Panel에서 코딩 변경
//  - Switch 입력 받으면 밸브 동작하라고 LoRa로 전송
//
//
...
const char* UpstreamTopic18 = "application/3/device/910470b2f636f681/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-01
const char* DownstreamTopic18 = "application/3/device/910470b2f636f681/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-01
const char* UpstreamTopic18 = "application/3/device/e18a7fa2a0dd9544/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-02
const char* DownstreamTopic18 = "application/3/device/e18a7fa2a0dd9544/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-02
const char* UpstreamTopic18 = "application/3/device/ad7143eaf8fcf44f/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-03
const char* DownstreamTopic18 = "application/3/device/ad7143eaf8fcf44f/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-03
const char* UpstreamTopic18 = "application/3/device/721d393941206868/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-04
const char* DownstreamTopic18 = "application/3/device/721d393941206868/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-04
const char* UpstreamTopic18 = "application/3/device/a988de2d0a72229e/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-05
const char* DownstreamTopic18 = "application/3/device/a988de2d0a72229e/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-05
const char* UpstreamTopic18 = "application/3/device/450334cb5681aa88/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-06
const char* DownstreamTopic18 = "application/3/device/450334cb5681aa88/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-06
const char* UpstreamTopic18 = "application/3/device/fc333262fb78eef8/command/down";	// ginseng-ginsengcorperation-water-valve-otaa-07
const char* DownstreamTopic18 = "application/3/device/fc333262fb78eef8/event/up";	// ginseng-ginsengcorperation-water-valve-otaa-07
