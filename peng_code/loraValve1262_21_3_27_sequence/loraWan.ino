...
//      appData[5] = 0x30;
//    }
    sprintf(flowChar, "%04d", (int) (FL.ulong_val));
    ...
    sprintf(tempChar, "%03d", (int) (TP.float_val * 10));
    appData[11] = 0x54; // 'T'emperature
    appData[12] = (int)tempChar[0];      // 3 Int val
    appData[13] = (int)tempChar[1];      // value
    appData[14] = (int)tempChar[2];      // value
    sprintf(humiChar, "%03d", (int) (HM.float_val * 10));
    appData[15] = 0x48; // 'H'umidity
    appData[16] = (int)humiChar[0];      // 3 Int val
    appData[17] = (int)humiChar[1];      // value
    appData[18] = (int)humiChar[2];      // value
