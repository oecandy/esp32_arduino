...
void processTxJob(){
  ...
  msg["data"]["SW01"]["state"] = relayStatus[0];
  msg["data"]["SW02"]["state"] = relayStatus[1];
  msg["data"]["SW03"]["state"] = relayStatus[2];
  msg["data"]["SW04"]["state"] = relayStatus[3];
  msg["data"]["SW05"]["state"] = relayStatus[4];
  msg["data"]["SW06"]["state"] = relayStatus[5];
